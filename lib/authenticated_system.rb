module AuthenticatedSystem
    ...
    def self.included(base)
      base.send :helper_method, :current_user, :logged_in?, :admin? if base.respond_to? :helper_method
    end
  ...
  protected
    ...
    def current_user=(new_user)
      ...
      session[:token] = (new_user.nil? || new_user.is_a?(Symbol)) ? nil : new_user.token
